...
//   if (params.frinedId == '1002') return chatMsg1002
//   if (params.frinedId == '1003') return chatMsg1003
//   if (params.frinedId == '1004') return chatMsg1004
// })

// Mock.mock(/session\/getSessionMsg/, 'post', (config) => {
//   let params = JSON.parse(config.body)
//   if (params.sessionId == '0') return chatMsg01
//   if (params.sessionId == '1') return chatMsg02
//   if (params.sessionId == '2') return chatMsg03
//   return chatMsg04
// })
